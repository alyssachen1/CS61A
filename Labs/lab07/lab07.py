...
class Person:
    ...
    def ask(self, stuff):
        self.last = "Would you please " + stuff
        return self.say("Would you please " + stuff)

    def greet(self):
        self.last = "Hello, my name is " + self.name
...
class SmartFridge:
    ...
    def use_item(self, item, quantity):
        ...
        if self.items[self.item] == 0:
            return 'Oh no, we need more' + ' ' + str(self.item) + '!'
        return 'I have' + ' ' + str(self.items[item]) + ' ' + str(self.item) + ' ' + 'left'
