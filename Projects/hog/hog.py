...
def make_averaged(original_function, total_samples=1000):
    ...
    def average_value(*args):
        result1 = total_samples
        new_result = 0
        while result1 > 0:
            new_result += original_function(*args)
            result1 -= 1
        new_result /= total_samples #calculating the average
        return new_result #returns the average value
    return average_value #returns the function
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    while num_dice < 11:
        ...
        current_average = average(num_dice, dice)
        if current_average > final_average:
            final_average = current_average
            low_num_dice = num_dice
        num_dice += 1
    return low_num_dice
    # END PROBLEM 9
