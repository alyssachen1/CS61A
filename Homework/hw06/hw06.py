...
class Coin:
    ...
    def worth(self):
        coins_age = Mint.present_year - self.year
        return self.cents + abs(50 - coins_age) if coins_age > 50 else self.cents
...
class VendingMachine:
    ...
    def vend(self):
        if self.quantity == 0: 
            ...
            return f'Here is your {self.item} and ${change} change.' if change > 0 else f'Here is your {self.item}.'
...
class Player:
    ...
    def debate(self, other):
        random = make_test_random() 
        self.opponent = other
        probability = max(0.1, self.popularity / (self.popularity + self.opponent.popularity))
    ...
    def speech(self, other):
        ...
        self.opponent.popularity -= self.opponent.popularity // 10
